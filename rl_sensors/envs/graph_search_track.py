  ...
  def get_obs(self) -> Dict[str, Any]:
    ...
    if len(edges) > 0:
      ...
      edge_dict.update(
          ...
          relative_position=edge_dict['relative_position'] /
          (self.scenario['max_velocity'] * self.scenario['dt']),
          relative_velocity=edge_dict['relative_velocity'] /
          self.scenario['max_velocity'],
      )
